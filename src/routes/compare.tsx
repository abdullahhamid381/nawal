  ...
  head: () => ({
    meta: [
      { title: "Compare Products — Northbay Retail Co." },
      {
        name: "description",
        content:
          "Compare product prices, availability and specifications side by side before you buy.",
      },
  ...
  return (
    <>
      <PageHeader
        ...
        description="Add up to four products from any product card to compare them side by side."
                  ...
                  {items.map((p) => (
                    <th key={p.id} scope="col" className="p-4 text-left align-top">
                      <img
                        ...
                        height={120}
                        loading="lazy"
                        className="mb-3 size-24 rounded-lg border border-border object-cover"
                      />
                      <Link
                        to="/product/$slug"
                        params={{ slug: p.slug }}
                ...
                <tr>
                  ...
                  {items.map((p) => (
                    <td key={p.id} className="space-y-2 p-4">
                      <Button size="sm" className="w-full" onClick={() => addToCart(p.slug)}>
                        Add to cart
                      </Button>
                      <Button
                        size="sm"
